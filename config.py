...
interaction_fn_args.extend([10.0, 100.0, 0.0, -6.0])     
# parameters for interaction between item 0 and item 1
interaction_fn_args.extend([100.0, 0.0, -6.0, -6.0])     
# parameters for interaction between item 0 and item 2
interaction_fn_args.extend([10.0, 100.0, 1.0, -100.0])   
# parameters for interaction between item 1 and item 0
interaction_fn_args.extend([100.0, 0.0, -6.0, -6.0])     
# parameters for interaction between item 1 and item 1
interaction_fn_args.extend([10.0, 0.0, -2.0, 0.0])       
# parameters for interaction between item 1 and item 2  
interaction_fn_args.extend([100.0, 0.0, -100.0, -100.0]) 
# parameters for interaction between item 2 and item 0
interaction_fn_args.extend([10.0, 100.0, 1.0, -100.0])   
# parameters for interaction between item 2 and item 1
interaction_fn_args.extend([100.0, 0.0, -100.0, -100.0]) 
# parameters for interaction between item 2 and item 2
interaction_fn_args.extend([10.0, 100.0, 0.0, -6.0])     
